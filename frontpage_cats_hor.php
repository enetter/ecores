			...
			<div class="span8" >
				<?php	 for ($i=0; $i <1000 ; $i++) { 
					...
					if ($cat_id) {
						...
						<div class="row" >
							<div class="span2" style="height: 130px; margin-right:-20px;  border-left:20px solid <?php $color = ($cat->description) ? $cat->description : 'grey'; echo $color;?>;">
								<h3 style="margin-left:5px"> <?php echo $cat->name ?></h3>
							</div>
							<?php 
