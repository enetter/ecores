...
register_sidebar(array(	'name' => 'Encart Accueil',
												...
												'before_title' => '<h3>',
												'after_title' => '</h3>')); 
register_sidebar(array(	'name' => '2e Colonne Accueil',
												'before_widget' => '<ul id="sidebar-block"><div>',
												'after_widget' => '</div></ul>',
												'before_title' => '<h3>',
												'after_title' => '</h3>')); 
register_sidebar(array(	'name' => '2e Colonne Archive',
												'before_widget' => '<ul id="sidebar-block"><div>',
												'after_widget' => '</div></ul>',
												'before_title' => '<h3>',
												'after_title' => '</h3>')); 
register_sidebar(array('name' => '2e Colonne Article',
												'before_widget' => '<ul id="sidebar-block"><div>',
												'after_widget' => '</div></ul>',
												'before_title' => '<h3>',
												'after_title' => '</h3>'));     
register_sidebar(array(	'name' => '2e Colonne Page',
												'before_widget' => '<ul id="sidebar-block"><div>',
												'after_widget' => '</div></ul>',
												'before_title' => '<h3>',
												'after_title' => '</h3>')); 
register_sidebar(array(	'name' => '3e Colonne',
												'before_widget' => '<ul id="sidebar-block"><div>',
												'after_widget' => '</div></ul>',
												'before_title' => '<h3>',
												'after_title' => '</h3>')); 
